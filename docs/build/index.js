var app = (function (svelteRouting, svelteGantt) {
    ...
    function create_if_block$1(ctx) {
    	...
    	binding_callbacks.push(() => bind(datetime0, 'value', datetime0_value_binding, /*options*/ ctx[0].from));
    	...
    	binding_callbacks.push(() => bind(datetime1, 'value', datetime1_value_binding, /*options*/ ctx[0].to));
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		...
    		new svelteGantt.SvelteGanttExternal(document.getElementById('new-task'),
    		{
    				gantt,
